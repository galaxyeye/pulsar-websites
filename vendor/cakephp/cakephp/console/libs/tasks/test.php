 ...
 * @package       cakephp
 * @subpackage    cakephp.cakephp.console.libs.tasks
 ...
 * @param string $className the 'cakephp name' for the class ie. Posts for the PostsController
 * @access public
 */
...
/**
 * Gets the real class name from the cakephp short form.
 *
 * @param string $type The Type of object you are generating tests for eg. controller
 * @param string $class the Classname of the class the test is being generated for.
 ...
 * Sets the src. or plugin.plugin_name. prefix.
 *
 ...
 */
	function help() {
		$this->hr();
		$this->out("Usage: cakephp bake test <type> <class>");
		$this->hr();
		$this->out('Commands:');
		$this->out("");
