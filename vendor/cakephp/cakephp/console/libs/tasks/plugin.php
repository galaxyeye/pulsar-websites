 ...
 */
	function help() {
		$this->hr();
		$this->out("Usage: cakephp bake plugin <arg1> <arg2>...");
		$this->hr();
		$this->out('Commands:');
		$this->out();
		...
		$this->out("\tbakes model. Run 'cakephp bake model help' for more info.");
		$this->out();
		$this->out("plugin <name> controller");
		$this->out("\tbakes controller. Run 'cakephp bake controller help' for more info.");
		$this->out();
		$this->out("plugin <name> view");
		$this->out("\tbakes view. Run 'cakephp bake view help' for more info.");
		$this->out();
		$this->_stop();
	}
}
