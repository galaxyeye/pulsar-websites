 ...
 *
 * - To load config files from src/config use `Configure::load('configure_file');`.
 ...
 *
 * @param array $paths paths defines in config/bootstrap.old.txt
 ...
 *    'view', 'helper', 'datasource', 'src', and 'cakephp'
