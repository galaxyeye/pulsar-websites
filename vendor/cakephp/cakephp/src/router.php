...
/**
 * Gets the named route elements for use in src/config/routes.php
 *
 ...
 *   is not in the root directory, this can be used to generate urls that are 'cakephp relative'.
 *   cakephp relative urls are required when using requestAction.
