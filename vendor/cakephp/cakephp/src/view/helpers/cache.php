 ...
 * The strings are found between <cakephp:nocache><cakephp:nocache> in views
 *
 * @var array
 * @access private
 */
 ...
 * The strings are any content inside <cakephp:nocache><cakephp:nocache> and includes the tags in views
 *
 * @var array
 * @access private
 */
 ...
 */
	function __parseFile($file, $cache) {
		...
		preg_match_all('/(<cakephp:nocache>(?<=<cakephp:nocache>)[\\s\\S]*?(?=<\/cakephp:nocache>)<\/cakephp:nocache>)/i', $cache, $outputResult, PREG_PATTERN_ORDER);
		preg_match_all('/(?<=<cakephp:nocache>)([\\s\\S]*?)(?=<\/cakephp:nocache>)/i', $file, $fileResult, PREG_PATTERN_ORDER);
 ...
 * @return string with all replacements made to <cakephp:nocache><cakephp:nocache>
 * @access private
 */
