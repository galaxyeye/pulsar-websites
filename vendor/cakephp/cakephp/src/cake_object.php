 ...
 * @param integer $type Error type constant. Defined in src/config/core.php.
 ...
 * If there is a file src/error.php or src/app_error.php this file will be loaded
 ...
 */
	function cakeError($method, $messages = array()) {
		if (!class_exists('ErrorHandler')) {
			...
			if (file_exists(APP_SRC . 'error.php')) {
				include_once (APP_SRC . 'error.php');
			} elseif (file_exists(APP_SRC . 'app_error.php')) {
 ...
 * @param CakeObject $object the object to persist
