 ...
 *
 * Provides an interface for loading and enumerating connections defined in src/config/database.php
 *
 ...
 *
 * @param mixed $connName A string name of the connection, as defined in src/config/database.php,
 *                        or an array containing the filename (without extension) and class name of the object,
 *                        to be found in src/models/datasources/ or cakephp/src/model/datasources/.
