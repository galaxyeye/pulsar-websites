 ...
 * @package       cakephp
 * @subpackage    cakephp.cakephp.libs.model
 ...
 *
 * @param string $dataSource The name of the DataSource, as defined in src/config/database.php
 * @return boolean True on success
 * @access public
 */
