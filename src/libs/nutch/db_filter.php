...
class DbFilter {
	/**
	 * TODO : is it a good idea to allocate a table for each user?
	 */
	private $data = array (
			'startKey' => null,
			'endKey' => null,
	...
	public function __construct($startKey = null, $endKey = null, $urlFilter = null, $fields = null, $start = 0, $limit = 100, $batchId = null, $storageCrawlId = null) {
