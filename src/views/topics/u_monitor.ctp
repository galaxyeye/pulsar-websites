    ...
    <div class="actions">
        <div class="head cl">
            ...
            <div class="sub-nav two columns">
                <a style="background: darkblue; padding: 3px; color: white">数据</a>
    ...
    <div class="doc-list">
        <div class="doc-list-actions cl">
            ...
            <div class="show-mode two columns">
                ...
                <span class="result-counter"><?php echo $this->Paginator->counter(['format' => __('共计%count%条数据', true)])?></span>
            </div>
        </div>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            foreach ($docs as $doc):
                ...
                $publishTime = date_create($doc['publish_time']);
                $publishTime = date_format($publishTime, "Y-m-d H:i:s");
                ...
                <tr>
                    ...
                    <td style="width:1em;"><?= $doc['alert'] ?></td>
                    <td style="width:1em;"><?= $doc['sentiment'] ?></td>
                    <td style="width:30em;">
                    ...
                    <td class="hidden"><?= $doc['shortContent'] ?></td>
                    <td><?= $publishTime ?></td>
                    <td><?= $doc['source_site'] ?></td>
                    <td><?= $doc['author'] ?></td>
                    <td><?= $doc['similar_data'] ?></td>
                    <td style="width:1em;"><?= $doc['click_forward'] ?></td>
                    <td style="width:1em;"><?= $doc['comment_count'] ?></td>
                    <td style="width:11em;" class="actions">
