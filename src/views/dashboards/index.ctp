...
<div class="horizon-nav2">
    <ul class='larger'>
        <li><?php echo $this->Html->link(__('简单任务向导', true),
                ['controller' => 'crawls', 'action' => 'analysis'], ['target' => '_blank']); ?></li>
    </ul>
</div>
...
<div class="horizon-nav2">
    <ul>
        <li><?php echo $this->Html->link(__('创建网络实体集', true),
                ['controller' => 'crawls', 'action' => 'addWes'], ['target' => '_blank']); ?></li>
        <li><?php echo $this->Html->link(__('创建通用爬虫任务', true),
                ['controller' => 'crawls', 'action' => 'add'], ['target' => '_blank']); ?></li>
    </ul>
</div>
...
<div class="horizon-nav2">
    <ul>
        <li><?php echo $this->Html->link(__('Hdfs Web UI', true),
                "http://" . HDFS_NAME_NODE_SERVER . ":" . HDFS_NAME_NODE_PORT, ['target' => '_blank']) ?></li>
        <li><?php echo $this->Html->link(__('Yarn Web UI', true),
                "http://" . HDFS_NAME_NODE_SERVER . ":" . YARN_RESOURCE_MANAGER_PORT, ['target' => '_blank']) ?></li>
        <li><?php echo $this->Html->link(__('HBase Web UI', true),
                "http://" . HBASE_HMASTER_SERVER . ":" . HBASE_HMASTER_PORT, ['target' => '_blank']) ?></li>
        <li><?php echo $this->Html->link(__('Solr Web UI', true),
                "http://" . SOLR_ADMIN_SERVER . ":" . SOLR_ADMIN_PORT, ['target' => '_blank']) ?></li>
    </ul>
</div>
...
<div class="dashboards crawls index">
    <h2><?php __('Crawls'); ?></h2>
