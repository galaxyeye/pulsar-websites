  ...
  <div class="row">
   <div
    ...
    <h2 data-aos="fade-up" data-aos-delay="400">使用 AI 和 SQL
     将任意授权网站完整精确转变成数据。现在，您可以直接在 Web 上应用商业智能。</h2>
    ...
    <div class="col-lg-5" data-aos="fade-up" data-aos-delay="150">
     ...
     <ul>
      <li><i class="ri-check-double-line"></i> <b>X-SQL</b> - 架构在 Web 上的
       SQL 引擎，Web 和本地数据库同等对待</li>
      <li><i class="ri-check-double-line"></i> <b>人工智能</b> -
       人工智能驱动的自动网页挖掘技术，零干预或极少干预，超大规模网页<b>完整精确</b>还原为数据</li>
      <li><i class="ri-check-double-line"></i> <b>弹性计算</b> -
       分布式网页渲染引擎满足任意规模的数据采集需求</li>
      <li><i class="ri-check-double-line"></i> <b>商业智能</b> - 在 Web
       上应用商业智能，捕捉成千上万高价值事件，回答利益攸关的业务问题</li>
     </ul>
    </div>
       ...
       <div class="col-md-6 d-md-flex align-items-md-stretch">
        <div class="count-box">
         <i class="icofont-simple-smile"></i> <span><b
          data-toggle="counter-up">50</b><b style="font-size: smaller">%</b></span>
         <p>
          <strong>成本节约</strong>
       ...
       <div class="col-md-6 d-md-flex align-items-md-stretch">
        <div class="count-box">
         <i class="icofont-document-folder"></i> <span><b
          data-toggle="counter-up">20</b><b style="font-size: smaller">x</b></span>
         <p>
          <strong>数据规模</strong>
       ...
       <div class="col-md-6 d-md-flex align-items-md-stretch">
        <div class="count-box">
         <i class="icofont-clock-time"></i> <span><b
          data-toggle="counter-up">90</b><b style="font-size: smaller">%</b></span>
         <p>
          <strong>交付时效</strong>
