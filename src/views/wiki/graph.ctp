...
<head>
  ...
  <style>
    ...
    .message { position : absolute; left : 5px; top : 80px; min-width : 300px; margin-left:50px; z-index : 100000; width : ３0%;}
...
<body>
	...
	<div class='stage'>
		<div class='search_box'>
		  <div class='input'>
		    <input type="text" name="name" id="queryName" value="<?=$subject ?>" />
    ...
    <script type="text/javascript">
    	...
    	function showGraph() {
        	var subject = $('#queryName').val();
    	    $.getJSON(graphUrl + '?subject=' + subject + "&t=" + new Date().getTime(), function(graph) {
