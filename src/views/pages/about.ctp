...
<div id="about" class="area">
	<div id="framenFB1F2" class="frame move-span cl frame-1-3">
		<div id="framenFB1F2_left" class="column frame-1-3-l">
			<div><img src="../img/common/icon2.gif"/><a href="about" id="current">关于我们</a></div>
		...
		<div id="framenFB1F2_center" class="column frame-1-3-r">
			...
			<div id="framenFB1F2_center_content" class="content">
				...
				<p>&nbsp;</p>
				<p>3. 应用领域								</p>
				<p>我们的企业合作方覆盖各行各业，能免费为广大网民提供生活中所需要的各种产品或服务。 </p>
				...
				<p align="left">&nbsp;</p>
				<p>我们始终倡导“分享每一天”的理念，并且让这一理念贯穿于用户与企业之间，并致力于打造中国最有价值的企业广告娱乐网站，为用户和企业创造最大的价值，为推动企业广告娱乐化的发展做出应有的贡献。 </p>
				<p>&nbsp;</p>
				<p>&nbsp;</p>
				<p><br />
				</p>
