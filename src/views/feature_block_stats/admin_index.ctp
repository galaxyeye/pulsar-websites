...
<div class="featureBlockStats index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $featureBlockStat['FeatureBlockStat']['domain']; ?>&nbsp;</td>
		<td><?php echo $featureBlockStat['FeatureBlockStat']['name']; ?>&nbsp;</td>
		<td><?php echo $featureBlockStat['FeatureBlockStat']['description']; ?>&nbsp;</td>
		<td><?php echo $featureBlockStat['FeatureBlockStat']['features']; ?>&nbsp;</td>
		<td>
