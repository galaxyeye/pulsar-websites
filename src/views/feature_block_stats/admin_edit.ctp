...
<?php echo $this->Form->create('FeatureBlockStat');?>
	<fieldset>
 		<legend><?php __('Admin Edit Feature Block Stat'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('FeatureBlockStat.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('FeatureBlockStat.id'))); ?></li>
