 ...
 * is the filename of the layout in /src/views/layouts without the .ctp
 * extension.
 *
 * @var string
 * @access public
 ...
 *
 * @param mixed $url A string or array-based URL pointing to another location within the src,
 *     or an absolute URL
