 ...
 */
	function help() {
		...
		$this->out(__('By default the .pot file(s) will be place in the locale directory of -src', true));
		$this->out(__('By default -src is ROOT/src', true));
		$this->hr();
		$this->out(__('Usage: cakephp i18n extract <command> <param1> <param2>...', true));
		$this->out();
		$this->out(__('Params:', true));
		$this->out(__('   -src [path...]: directory where your application is located', true));
		$this->out(__('   -root [path...]: path to install', true));
		$this->out(__('   -core [path...]: path to cakephp directory', true));
		...
		$this->out(__('   cakephp i18n extract help: Shows this help message.', true));
		$this->out();
	}
