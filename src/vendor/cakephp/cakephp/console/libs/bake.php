 ...
 * @package       cakephp
 * @subpackage    cakephp.cakephp.console.libs
 ...
 */
	function help() {
		...
		$this->hr();
		$this->out("Usage: cakephp bake <command> <arg1> <arg2>...");
		$this->hr();
		$this->out('Params:');
		$this->out("\t-src <path> Absolute/Relative path to your src folder.\n");
		$this->out('Commands:');
		$this->out("\n\tbake help\n\t\tshows this help message.");
		$this->out("\n\tbake all <name>\n\t\tbakes complete MVC. optional <name> of a Model");
		$this->out("\n\tbake project <path>\n\t\tbakes a new src folder in the path supplied\n\t\tor in current directory if no path is specified");
