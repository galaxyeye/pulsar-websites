 ...
 */
/**
  * @modified    i'Vincent<peregrinator@msn.cn>
 */
    ...
    Lang.augmentObject(E.Instance.prototype, {
        ...
        _setupContentPanel: function() {
            var doc = this.contentDoc,
                ...
                contentCSSUrl = config.base + config.css_dir + config.kissy_dir + THEMES_DIR + "/" + config.theme + "/" + contentCSS,
                self = this;
...
KISSY.Editor.add("plugins~smiley", function(E) {
    ...
    E.addPlugin("smiley", {
        ...
        _renderIcons: function(config) {
            var base = this.editor.config.base + this.editor.config.img_dir + this.editor.config.kissy_dir 
            		+ "smilies/" + config["name"] + "/",
