$(document).ready(function () {
    ...
    function processStep2() {
        ...
        layer.open({content: $(".add-wes.form")});
    ...
    function processStep3() {
        layer.tips('现在可以点击启动爬虫了。', '.submit input[type=submit]');
    } // processStep3
...
//         });
        ...
        layer.open({title: '准备抽取', content: $("#confirmExtraction")});
    ...
    function showExtractResultAsWebsite(outFolder) {
        ...
        layer.open({content: $("#autoExtractResult")});
    } // showExtractResultAsWebsite

    function showMiningResult() {
        layer.closeAll();
        layer.open({content: $("#miningResult")});
