...
<div class="actions">
  <ul>
    <li><?php echo $this->Html->link(__('View Crawl Status', true), array('action' => 'status', $crawl['Crawl']['id']), array('target' => '_blank')); ?> </li>
    ...
    <li><?php echo $this->Html->link(__('测试解析器', true),
    ...
    <li><?php echo $this->Html->link(__('Nutch配置项', true),
    		array('controller' => 'nutch_jobs', 'action' => 'nutchConfig', $crawl['Crawl']['configId']),
    		array('target' => '_blank')); ?></li>
    <li><?php echo $this->Html->link(__('查看网页', true),
    		array('controller' => 'web_pages', 'action' => 'searchByUrl', simple_encode($crawl['Seed'][0]['url'])),
    		array('target' => '_blank', 'title' => '解析种子链接')); ?></li>
    <?php endif ?>
  </ul>
</div>
...
<div class="related seeds">
  ...
  <?php 
    ...
    <tr <?php echo $class;?>>
      ...
      <td><pre><?php echo $seed['url'];?></pre></td>
      <td class="actions">
        <?php 
