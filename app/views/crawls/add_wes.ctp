...
<?php echo $this->Form->create('Crawl'); ?>
	<fieldset>
		...
		echo $this->Form->input('PageEntity.0.name', array('label' => '实体名', 'after' => $m['PageEntity.name']));

		echo $this->Form->input('description', array('label' => '简单说明（可选）', 'rows' => '1'));
	?>
	</fieldset>
