<?php
	$this->set('title_for_layout', '会员管理 - 区域管理 - logoloto');
	...
	if ($current == NULL){
		...
		$this->viewVars['sub_title_for_layout'] = 
			'隶属于'
			.$html->link($current['name'], array('controller' => 'areas', 'action' => 'view', 
				(isset($parent['id']) ? $parent['id'] : 0)))
			.'的区域';
	}
?>
