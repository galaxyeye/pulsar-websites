...
<?php echo $this->Form->create('SparkJob');?>
	<fieldset>
 		<legend><?php __('Edit Spark Job'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('SparkJob.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('SparkJob.id'))); ?></li>
