...
<?php echo $this->Form->create('FeatureBlockText');?>
	<fieldset>
 		<legend><?php __('Admin Edit Feature Block Text'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('FeatureBlockText.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('FeatureBlockText.id'))); ?></li>
