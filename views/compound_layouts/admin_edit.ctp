...
<?php echo $this->Form->create('CompoundLayout');?>
	<fieldset>
 		<legend><?php __('Admin Edit Compound Layout'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('CompoundLayout.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('CompoundLayout.id'))); ?></li>
