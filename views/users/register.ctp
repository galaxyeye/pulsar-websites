			...
			<div id="register-frame">
				...
				<div class="register-page">
					...
					<div class="register-row colored-bg" id="reg-email">
						...
						<div class="desc" id="reg-email-desc1">请输入正确的邮箱，完成注册</div>
						<div class="desc" id="reg-email-desc2" style="display:none;"><img /><span></span></div>
					</div>
					<div class="register-row" id="reg-password">
						...
						<div class="desc" id="reg-password-desc1">密码必须由6-18个字符组成</div>
						<div class="desc" id="reg-password-desc2" style="display:none;"><img /><span></span></div>
					</div>
					<div class="register-row colored-bg" id="reg-repeat">
						...
						<div class="desc" id="reg-repeat-desc1">请再输一遍密码</div>
						<div class="desc" id="reg-repeat-desc2" style="display:none;"><img /><span></span></div>
					</div>
					<div class="register-row" id="reg-name" id="reg-name">
						...
						<div class="desc" id="reg-name-desc1">会员名由3-12个字符组成</div>
						<div class="desc" id="reg-name-desc2" style="display:none;"><img /><span></span></div>
					</div>
					<div class="register-row colored-bg" id="reg-captcha">
						...
						<div class="desc" id="reg-captcha-desc" style="display:none;"><img /><span></span></div>
